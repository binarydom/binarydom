...
async function create(name, options) {
    ...
    try {
        ...
        await (0, promises_1.writeFile)((0, path_1.resolve)(projectDir, "package.json"), JSON.stringify(packageJson, null, 2));
        ...
        await (0, promises_1.writeFile)((0, path_1.resolve)(projectDir, "tsconfig.json"), JSON.stringify(tsconfig, null, 2));
        // Create source directory and initial files
        await (0, promises_1.mkdir)((0, path_1.resolve)(projectDir, "src"));
        // Create index.ts
        const indexContent = `
...
renderer.render(App());
`;
        await (0, promises_1.writeFile)((0, path_1.resolve)(projectDir, "src/index.ts"), indexContent);
        // Create App.ts
        const appContent = `
...
`;
        await (0, promises_1.writeFile)((0, path_1.resolve)(projectDir, "src/App.ts"), appContent);
        // Create index.html
        const htmlContent = `
<!DOCTYPE html>
<html>
...
`;
        await (0, promises_1.writeFile)((0, path_1.resolve)(projectDir, "index.html"), htmlContent);
